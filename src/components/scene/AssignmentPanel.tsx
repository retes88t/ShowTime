...
export function AssignmentPanel({ assignments, escenaId, onRefresh }: AssignmentPanelProps) {
  ...
  return (
    <div>
      ...
      {assignments.length === 0 ? (
        <EmptyState message="No hay asignaciones para esta escena." action="Crear asignacion" onAction={openAdd} />
      ) : (
