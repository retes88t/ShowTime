...
export function MaterialsList({ materials, escenaId, onRefresh }: MaterialsListProps) {
  ...
  return (
    <div>
      ...
      {materials.length === 0 ? (
        <EmptyState message="No hay materiales registrados." action="Agregar material" onAction={openAdd} />
      ) : (
